# sdd-scaffolding — Project Structure
...
|----------------------|----------------|------------------------|--------------------------|
| Changing a seeded skill, script or docs skeleton | `area:seed-content` | `skills/<name>/SKILL.md`, `scripts/sdd/`, `seed/` | the matching `seed/` copy (kept byte-identical), `sizeBudgetBytes` in `skills/sdd.config.json`, `scripts/sdd/.seed-manifest.json` |
